#' mymlnorm
#'
#' @param x Sample of vector data points
#' @param mu Vector of potential mean values
#' @param sig Vector of potential standard deviation values
#' @param ... Allows for additional arguments to be passed to the function
#'
#' @return A list with x, coord, and maxl
#' @export
#'
#' @examples
